...
public class VariableRegistryUpdateStepDTO {
  ...
  public VariableRegistryUpdateStepDTO description(String description) {
  ...
  **/
  ...
  public VariableRegistryUpdateStepDTO complete(Boolean complete) {
  ...
  **/
  ...
  public VariableRegistryUpdateStepDTO failureReason(String failureReason) {
