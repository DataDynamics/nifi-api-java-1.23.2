...
public class ProcessGroupStatusSnapshotDTO {
    ...
    @SerializedName("processingNanos")
    ...
    public ProcessGroupStatusSnapshotDTO versionedFlowState(VersionedFlowStateEnum versionedFlowState) {
