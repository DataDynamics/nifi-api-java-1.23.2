...
public class VersionControlInformationDTO {
    ...
    public VersionControlInformationDTO registryName(String registryName) {
    ...
    public VersionControlInformationDTO bucketName(String bucketName) {
     ...
     **/
    @ApiModelProperty(value = "The storage location")
    ...
    public VersionControlInformationDTO state(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public VersionControlInformationDTO stateExplanation(String stateExplanation) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(groupId, registryId, registryName, bucketId, bucketName, flowId, flowName, flowDescription, version, storageLocation, state, stateExplanation);
    }
